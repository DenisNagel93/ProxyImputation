...
public class ColumnPair {
    ...
    //The set of records associated with each column
    ArrayList<Record> columnA, columnB;
    //The records relevant for the narrative associated with each column (according to previous instance matching)
    HashSet<Record> relevantA, relevantB;
    //Attribute represented by each column
    Attribute a,b;
