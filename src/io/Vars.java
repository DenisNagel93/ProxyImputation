...
public class Vars {
    ...
    public static HashMap<String, HashSet<Attribute>> captionIndex = new HashMap<>();
        ...
        while ((line = br.readLine()) != null) {
            ...
            switch (sub[0]) {
                ...
                case "embeddings_path": Vars.embeddingPath = sub[1];
                    break;
                case "augment_path": Vars.augmentPath = sub[1];
                    break;
                case "ontology_path": Vars.ontologyPath = sub[1];
                    break;
    ...
    public static void buildIndexes() {
        for (DataSet d : dataSets) {
            ...
            for (Attribute a : d.getAttributes()) {
                ...
                if (captionIndex.containsKey(atrTitle)) {
                    captionIndex.get(atrTitle).add(a);
                } else {
                    HashSet<Attribute> as = new HashSet<>();
                    as.add(a);
                    captionIndex.put(atrTitle,as);
                }
    ...
    public static void prepareEmbedding() throws IOException {
    ...
    public static String getAugmentPath() {
        return augmentPath;
    }
